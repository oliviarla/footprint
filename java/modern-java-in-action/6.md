...
<figure><img src="../../.gitbook/assets/image (142).png" alt=""><figcaption><p>supplier -> accumulator -> finisher</p></figcaption></figure>
...
*   병렬 리듀싱 수행 과정
    ...
    * 컬렉터의 combiner 메서드가 반환하는 함수를 사용해 서브스트림의 결과들을 합친다.
    ...
    <figure><img src="../../.gitbook/assets/image (143).png" alt=""><figcaption><p>processing parallel stream</p></figcaption></figure>
